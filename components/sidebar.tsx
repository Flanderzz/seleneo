...
export function Sidebar() {
    ...
    return (
        <aside className="flex w-24 overflow-x-hidden border-r border-border/60 md:min-w-100 md:max-w-100">
            <ul className="no-scrollbar relative flex basis-full flex-col items-center gap-6 overflow-x-hidden border px-4 py-4 md:max-w-[28%] md:basis-[28%] md:border-r">
