    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button className={cn('hover:bg-card opacity-80 hover:opacity-100 bg-card outline-hidden ring-0 stroke-none border-none')} size="icon">
                    <Sun className="h-4 w-4 rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0 light:rotate-0 light:scale-100 stroke-black dark:stroke-primary" />
