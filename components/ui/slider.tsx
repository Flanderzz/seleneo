    ...
    <div className="flex w-full items-center gap-2.5">
        ...
        >
            ...
            <SliderPrimitive.Thumb
                ...
                className="block h-5 w-5 rounded-md border border-border bg-background ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 active:outline-hidden active:ring-2 active:ring-ring active:ring-offset-2 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 dark:bg-primary"
            />
        </SliderPrimitive.Root>
        <Button
            variant="ghost"
