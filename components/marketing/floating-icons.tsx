    ...
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="invisible lg:visible absolute top-32 left-[30%] md:left-[35%] opacity-0 animate-fade-in-1">
                <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-3 rounded-2xl shadow-xl animate-float-slow">
            ...
            <div className="absolute top-32 md:top-28 right-[7%] md:right-[32%] opacity-0 animate-fade-in-2">
                <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-3 rounded-2xl shadow-xl animate-float-delayed">
            ...
            <div className="invisible lg:visible absolute top-92 md:top-96 left-[10%] md:left-[20%] opacity-0 animate-fade-in-4">
                <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-3 rounded-2xl shadow-xl animate-float-slow">
      ...
      <div className="absolute bottom-16 md:bottom-20 left-[20%] md:left-[25%] opacity-0 animate-fade-in-3">
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-3 rounded-2xl shadow-xl animate-float">
      ...
      <div className="absolute bottom-32 md:bottom-40 right-[10%] md:right-[15%] opacity-0 animate-fade-in-4">
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-3 rounded-2xl shadow-xl animate-float-fast">
          <Zap className="w-6 h-6 text-blue-300" />
        </div>
      </div> */}

            <div className="absolute top-1/4 -left-12 w-36 h-px animate-pulse bg-linear-to-r from-transparent via-blue-500 to-transparent rotate-12" />
            <div className="absolute top-1/3 -right-12 w-36 h-px animate-pulse delay-300 bg-linear-to-l from-transparent via-blue-400 to-transparent -rotate-12" />
            <div className="absolute bottom-1/4 -left-12 w-36 h-px animate-pulse delay-700 bg-linear-to-r from-transparent via-blue-300 to-transparent rotate-6" />
